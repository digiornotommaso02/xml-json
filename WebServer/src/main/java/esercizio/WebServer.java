...
public class WebServer implements Runnable{
   ...
   static final File WEB_ROOT = new File(".");
	static final String DEFAULT_FILE = "index.html";
        static final String MOVED_PERMANENTLY = "index.html";
		...
		try {
			...
			if (!method.equals("GET")  &&  !method.equals("HEAD")) {
				...
				if (fileRequested.endsWith("/")) {
                                    ...
                                    XmlMapper xmlMapper = new XmlMapper();
                                    xmlMapper.writeValue(new File("xml.xml"), v);
                                    File fileinxml = new File("xml.xml");
                                    File file = new File(WEB_ROOT, FILE_NOT_FOUND);
                                    int fileLength = (int) file.length();
                                    String content = "application/xml";
                                    ...
                                    v = database.takevalue();
                                    try {
                                        File fileJSON = new File(WEB_ROOT, "json.json");
                                        ObjectMapper objectMapper = new ObjectMapper();
                                        objectMapper.writeValue(new FileOutputStream("json.json"), v);
                                        File fileinjson = new File("json.json");
